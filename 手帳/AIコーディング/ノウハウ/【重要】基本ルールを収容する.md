---
notion-id: 2f637ce628718065b818ffd2ecadd0bc
テキスト: 20260128これは、これまで開発してきた中でAIコーディングする上で常に意識させておきたいと考えたルール群開発時はまずこれらをルートに配置し、それから進めることでスムーズな開発が期待できる
ファイル&メディア:
  - "[[ai-coding-guidelines_(1).tar.gz]]"
選択:
  - コーディング
---
````markdown
